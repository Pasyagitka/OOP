...
namespace Shop
{
    ...
    public partial class App : Application
    {
        ...
        public static CultureInfo Language
        {
            ...
            set
            {
                ...
                ResourceDictionary oldDict = (from d in Application.Current.Resources.MergedDictionaries
                                              where d.Source != null && d.Source.OriginalString.StartsWith("ResourceDictionary/lang.")
                                              select d).First();
                if (oldDict != null)
                {
        ...
        {
            Shop.Properties.Settings.Default.DefaultLanguage = Language;
            Shop.Properties.Settings.Default.Save();
        }
    }
}
